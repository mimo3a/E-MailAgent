...
//	fur die Eingabefelder
	...
	private String  titelString,senderString, betreffString, inhaltString;
...
//	der Konstruktor
	public Antworten(JFrame parent, boolean modal, String titel, String sender, String betreff, String inhalt) {
		super(parent, modal);
		this.titelString = titel;
		this.senderString = sender;
		this.betreffString = betreff;
		this.inhaltString = inhalt;
...
//		hier den Dialog ausblenden und loeschen
	...
	private void initGui() {
		...
		empfaenger = new JTextField(senderString);
		oben.add(empfaenger);
		oben.add(new JLabel("Betreff: "));
		betreff = new JTextField(betreffString);
		oben.add(betreff);
		add(oben, BorderLayout.NORTH);
		inhalt = new JTextArea(inhaltString);
